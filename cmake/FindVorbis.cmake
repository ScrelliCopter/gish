...
``Vorbis_Enc_LIBRARY``
  The path to the vorbisenc library.B
``Vorbis_File_LIBRARY``
...
find_path (Vorbis_Enc_INCLUDE_DIR
	NAMES
		vorbis/vorbisenc.h
	PATHS
		~/Library/Frameworks
...
if (Vorbis_Vorbis_LIBRARY AND Vorbis_Vorbis_INCLUDE_DIR AND Ogg_FOUND)
	...
	if (APPLE AND "${Vorbis_Vorbis_LIBRARY}" MATCHES "\\.framework$")
		set (Vorbis_FRAMEWORK TRUE)
		mark_as_advanced(Vorbis_FRAMEWORK)
	endif ()
endif ()
    ...
    if (NOT TARGET Vorbis::vorbis)
		if (Vorbis_FRAMEWORK)
			...
			set_target_properties (Vorbis::vorbis PROPERTIES
				...
				IMPORTED_LOCATION "${Vorbis_Vorbis_LIBRARY}/Vorbis"
